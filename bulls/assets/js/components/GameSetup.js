...
function IsReady({ ready }){
    return (
        <div>
            <input onChange={(ev) => ready(ev)} type="checkbox" id="isReady" value="Ready"/>
...
function GameSetup({appState, ch_ready, ch_change_player_type}) {
  ...
  function handleChange(ev) {
      ...
      console.log("pType", ev.target.value)
    ...
    <div>
      ...
      <div className="row">
        <div className="column">
          ...
          <select id="playerType" name="playerType" value={playerType} onChange={handleChange}>
